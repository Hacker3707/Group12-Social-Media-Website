        ...
        <div class="container px-0">
            ...
            <div class="p-4 relative">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link" href="index.php?controller=group&action=detail&id=<?= htmlspecialchars($group['GroupID']) ?>">Thảo luận</a></li>
                    <li class="nav-item"><a class="nav-link active" href="index.php?controller=group&action=viewMembersinDetailGroup&id=<?= htmlspecialchars($group['GroupID']) ?>">Thành viên</a></li>
                </ul>
            ...
            <div class="col-md-8">
                ...
                <?php if ($canInteract): ?>
                    <div class="card border-0 shadow-sm p-3 mb-5">
                        <div class="text-muted mb-2 font-weight-bold">Thành viên trong nhóm</div>
                        <?php if(!empty($membersInGroup)): ?>
                            <?php foreach($membersInGroup as $user): ?>
                                <?php include __DIR__ . "/../partials/user_card.php"; ?>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <div class="alert alert-secondary mb-0">Nhóm này chưa có thành viên nào được duyệt.</div>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
