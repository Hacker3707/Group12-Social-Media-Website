...
<head>
    ...
    <style>
        ...
        .avatar-container { width: 168px; height: 168px; border-radius: 50%; overflow: hidden; position: relative; margin-top: -100px; margin-bottom: 15px; margin-left: auto; margin-right: auto; background-color: #fff; }
...
<body>
    ...
    <div class="container content-section" style="background-color:#e6efff; padding:20px; border-radius:10px;">
        <div class="row">
            <div class="col-md-5">
            ...
            <div class="col-md-7">
                ...
                <div class="card card-custom p-3 mb-3">
                    <div class="d-flex align-items-center">
                        <img src="<?= !empty($user['AvatarFP']) ? $user['AvatarFP'] : 'https://via.placeholder.com/40' ?>"
                             class="rounded-circle mr-2" width="40" height="40">
                        <input type="text" class="form-control rounded-pill bg-light"
                               placeholder="<?= htmlspecialchars($user['Username']) ?> ơi, bạn đang nghĩ gì thế?"
