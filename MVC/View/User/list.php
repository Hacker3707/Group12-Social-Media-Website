...
<body>
    <div class="container-fluid" id="home-container">
        ...
        <div class="row" id="middle-content">
            <div class="col-12 col-lg-2 mb-3 mb-lg-0" id="left-sidebar" style="">
            ...
            <div class="col-12 col-lg-10" id="main-content">
                <div class="card shadow-sm border-0 rounded-lg">
                    <div class="card-header bg-white d-flex flex-column flex-md-row justify-content-between align-items-md-center py-3">
                        <h4 class="mb-3 mb-md-0 font-weight-bold text-primary">
                            <i class="fas fa-users-cog"></i> Quản lý Hệ thống Người dùng
                        </h4>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0 text-center">
                                ...
                                <tbody>
                                    <?php if (empty($users)): ?>
                                        <tr>
                                            <td colspan="6" class="py-4 text-muted">Không tìm thấy người dùng nào!</td>
                                        </tr>
                                    <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <?php
                                                        ...
                                                        if ($status === 'active') {
                                                            echo '<span class="badge badge-success px-2 py-1">Hoạt động</span>';
                                                        } elseif ($status === 'banned') {
                                                            echo '<span class="badge badge-warning px-2 py-1">Bị Khóa</span>';
                                                        } else {
                                                            echo '<span class="badge badge-secondary px-2 py-1">Đã Xóa</span>';
                                                        }
                                                    ?>
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    <!-- Sửa hồ sơ -->
                                                    <a href="index.php?controller=user&action=edit&id=<?= $u->getUserId() ?>"
                                                       class="btn btn-sm btn-light border font-weight-bold text-primary mr-1"
                                                       title="Sửa hồ sơ">
                                                    ...
                                                    <?php if ($u->getUserId() != $_SESSION['user_id']): ?>
                                                        ...
                                                        <?php if ($u->getAccountStatus() !== 'banned'): ?>
                                                            <!-- Khóa -->
                                                            <a href="index.php?controller=user&action=ban&id=<?= $u->getUserId() ?>"
                                                               class="btn btn-sm btn-warning font-weight-bold text-dark mr-1"
                                                        ...
                                                        <?php else: ?>
                                                            <!-- Mở khóa -->
                                                            <a href="index.php?controller=user&action=unban&id=<?= $u->getUserId() ?>"
                                                               class="btn btn-sm btn-success font-weight-bold mr-1"
                                                        ...
                                                        <!-- Xóa -->
                                                        <a href="index.php?controller=user&action=delete&id=<?= $u->getUserId() ?>"
                                                           class="btn btn-sm btn-danger font-weight-bold"
                                                           onclick="return confirm('CẢNH BÁO: Xác nhận xóa người dùng này?')"
                                                           title="Xóa tài khoản">
