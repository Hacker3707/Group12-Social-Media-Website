...
<div class="card mb-3 shadow-sm">
  <div class="card-header bg-primary text-white align-items-center d-flex">
    ...
    <?php if ($group === null): ?>
      <h4>📝 Edit Post</h4>
    <?php else: ?>
      <h4>📝 Edit Post in Group <?= $group->getGroupName() ?></h4>
  ...
  <div class="card-body">
    ...
    <div class="form-group">
      <label>📌 Title</label>
      <input type="text" name="title" class="form-control" value="<?= htmlspecialchars($post->getTitle()) ?>">
    </div>

    <div class="form-group">
      <label>📂 Category</label>
      <select name="category_id" class="form-control">
        <option value="<?= htmlspecialchars($post->getCategoryId()) ?>">-- Category Name --</option>
    ...
    <div class="form-group">
      <label>📄 Content</label>
      <textarea name="content" class="form-control" rows="4"><?php $post -> getContent() ?></textarea>
    </div>
